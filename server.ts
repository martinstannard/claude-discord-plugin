...
mcp.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    {
      name: 'create_channel',
      description: 'Create a new text channel in a Discord server (guild). Requires Manage Channels permission.',
      inputSchema: {
        type: 'object',
        properties: {
          guild_id: { type: 'string', description: 'The server/guild ID to create the channel in.' },
          ...
          category_id: { type: 'string', description: 'Optional category (parent) ID to nest the channel under.' },
        },
